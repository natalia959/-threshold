  ...
  return (
    <>
      ...
      <div ref={panelRef} style={{
        ...
        width: 336, fontFamily: "var(--font-dm-sans), sans-serif",
      }}>
        ...
        {/* Bar — default: simple input field */}
        <div
    ...
    <div style={{ background: "#fff", color: "#0f0f0f", minHeight: "100vh" }}>
      ...
      <nav style={{
        ...
        <a href="/" style={{
          ...
          letterSpacing: "0.22em", color: "#0f0f0f",
      ...
      <div style={{ position: "relative", height: "100vh", overflow: "hidden" }}>
        ...
        <div style={{
          ...
          <div>
            <div style={{
              fontFamily: "var(--font-dm-sans), sans-serif", fontSize: 10,
          ...
          <div style={{ position: "sticky", top: 88 }}>
            {(property.bedrooms || property.bathrooms || property.sqft) && (
              <div style={{ marginBottom: 36 }}>
                <div style={{
                  fontFamily: "var(--font-dm-sans), sans-serif", fontSize: 9,
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 11 }}>
                  {[
                    ...
                    <div key={label} style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline" }}>
                      <span style={{ fontFamily: "var(--font-dm-sans), sans-serif", fontSize: 11, color: "#ccc", letterSpacing: "0.04em" }}>{label}</span>
                      <span style={{ fontFamily: "var(--font-dm-sans), sans-serif", fontSize: 12, color: "#888" }}>{value}</span>
                    </div>
                  ))}
                </div>
              </div>
                ...
                <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
                  {(property.idea_tags || []).map(tag => (
                    <span key={tag} style={{
                      ...
                      border: "1px solid #e6e2dc", borderRadius: 20, padding: "3px 11px",
                    }}>{tag}</span>
                  ))}
            ...
            {(property.agent_name || property.agent_brokerage) && (
              <div style={{ marginBottom: 36 }}>
                <div style={{
                  fontFamily: "var(--font-dm-sans), sans-serif", fontSize: 9,
                  letterSpacing: "0.18em", color: "#d0ccc6",
                ...
                <div style={{ fontFamily: "var(--font-dm-sans), sans-serif", fontSize: 12, color: "#888", lineHeight: 1.75 }}>
                  {property.agent_name}
                  {property.agent_brokerage && <><br /><span style={{ fontSize: 11, color: "#bbb" }}>{property.agent_brokerage}</span></>}
                </div>
              </div>
            )}
          </div>
